...
class EnvConfig implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->ignoreExtraKeys()
            ->children()
                  ->scalarNode('DB_EMAIL_TABLE_NAME')->cannotBeEmpty()->end()
                  ->scalarNode('DB_USER')->cannotBeEmpty()->end()
                  ->scalarNode('DB_PASSWORD')->end()
                  ->scalarNode('DB_HOST')->cannotBeEmpty()->end()
                  ->scalarNode('DB_PORT')->cannotBeEmpty()->end()
                  ->scalarNode('DB_SCHEMA')->cannotBeEmpty()->end()
